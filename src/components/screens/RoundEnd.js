...
const RoundEnd = ({
  ...
  return (
    <div className={`game-container min-h-screen flex flex-col items-center justify-center py-8 ${className}`}>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-2xl">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-semibold mb-3">Words Found ({words.length})</h3>
